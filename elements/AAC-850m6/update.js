function(instance, properties, context) {
	...
	let elementoExiste = document.body.contains(document.getElementById(properties.id))
    // caso o id informado seja diferente de null e o elemento exista
    if(properties.id !== null && elementoExiste){ //inicio do if 
